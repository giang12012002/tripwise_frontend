                        ...
                        <div className="w-full">
                            <div className="flex justify-end">
                                <button
                                    ...
                                    className="text-blue-200 text-sm font-normal underline hover:text-blue-700 focus:outline-none flex items-center ml-12"
                                >
                                    Xem thêm
                                    <svg
                        ...
                        <div className="w-full">
                            <div className="flex justify-start">
                                <button
                                    ...
                                    className="text-blue-500 text-sm font-normal underline hover:text-blue-700 focus:outline-none flex items-center"
                                >
                                    Xem thêm
                                    <svg
                                        className="w-4 h-4 ml-1"
