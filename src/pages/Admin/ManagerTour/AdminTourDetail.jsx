        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-100 py-12">
            <div className="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {tour.imageUrls && tour.imageUrls.length > 0 && (
                    <div className="flex flex-col md:flex-row bg-white p-6 rounded-2xl shadow-2xl mb-8 border border-blue-100">
                        <div className="relative md:w-1/2">
                            <span className="absolute top-4 left-4 bg-gradient-to-r from-red-500 to-red-600 text-white px-4 py-1 rounded-full text-sm font-bold shadow-md">
                                SALE HOT
                            </span>
                ...
                <div className="mt-12 flex justify-center space-x-6">
                    <button
                        className="px-6 py-4 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 transition-all duration-300 shadow-lg flex items-center text-lg font-semibold"
                    ...
                    <button
                        className="px-6 py-4 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-lg hover:from-red-700 hover:to-red-800 transition-all duration-300 shadow-lg flex items-center text-lg font-semibold"
